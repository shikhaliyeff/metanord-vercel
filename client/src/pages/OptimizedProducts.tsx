...
export default function OptimizedProductsPage() {
  ...
  // Setup optimization when component mounts
  useEffect(() => {
    ...
    // Register product images with the consolidated loader
    registerProductImages(productImagesMap);
    
    // Preload key images for improved perceived performance
    preloadImages([
