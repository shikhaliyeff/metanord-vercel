...
// If run directly as a script, perform analysis
if (require.main === module) {
  findMissingTranslations();
}
`;
  
  const scriptPath = path.join(__dirname, 'master-translation-update.js');
  fs.writeFileSync(scriptPath, scriptContent, 'utf8');
  console.log('Created master translation update script at master-translation-update.js');
}
